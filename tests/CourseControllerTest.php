...
class CourseControllerTest extends AbstractTest
{
    ...
    //     dd($crawler);
    //     $link = $crawler->selectLink(UserTestData::TEST_ADD)->link();
    //     $crawler = $client->click($link);
    //     $this->assertResponseOk();

    //     // заполняем форму создания курса корректными данными и отправляем
    //     $courseCreatingForm = $crawler->selectButton(UserTestData::TEST_SAVE)->form([
    ...
    //     $submitButton = $crawler->selectButton(UserTestData::TEST_UPDATE);
